...
using AcessandoApiRest.RefitInternalGenerated;
...
namespace AcessandoApiRest.RefitInternalGenerated
{
...
{
    using global::AcessandoApiRest.Model;
    using global::Refit;
    using global::System;
...
namespace AcessandoApiRest.Controller
{
    ...
    [Preserve]
    [global::System.Reflection.Obfuscation(Exclude=true)]
    partial class AutoGeneratedISessionApiService : ISessionApiService
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly IRequestBuilder requestBuilder;
        ...
        /// <inheritdoc />
        public AutoGeneratedISessionApiService(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
        ...
        /// <inheritdoc />
        Task<Token> ISessionApiService.PostLoginAsync(string json)
        {
            var arguments = new object[] { json };
            var func = requestBuilder.BuildRestResultFuncForMethod("PostLoginAsync", new Type[] { typeof(string) });
